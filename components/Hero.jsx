...
function Hero({ loading, isMobile }) {
  return (
    ...
    >
      ...
      >
        ...
        >
          <h1 className={`heroHeadText`}>
            Hi, I&apos;m{" "}
            <span className="dark:text-five text-primary">Shikhar</span>
          </h1>
      ...
      <div className="absolute z-20 items-center justify-center hidden xs:bottom-10 bottom-32 left-1/2 md:flex">
        <a href="#about">
